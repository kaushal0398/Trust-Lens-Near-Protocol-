import { NodeStatusResult, FinalityReference, AccessKeyView, AccessKeyList, BlockReference, AccountView, ContractCodeView, ContractStateView, CallContractViewFunctionResultRaw, BlockResult, ChunkId, ChunkResult, BlockId, GasPrice, EpochValidatorInfo, TxExecutionStatus, FinalExecutionOutcome, ExecutionOutcomeReceiptDetail, QueryResponseKind, RpcQueryRequest, BlockChangeResult, NearProtocolConfig, LightClientProofRequest, LightClientProof, NextLightClientBlockRequest, NextLightClientBlockResponse, ChangeResult, AccessKeyWithPublicKey } from '@near-js/types';
...
declare class FailoverRpcProvider implements Provider {
    ...
    callFunction(accountId: string, method: string, args: Record<string, unknown>, blockQuery?: BlockReference): Promise<string | number | boolean | object | undefined>;
