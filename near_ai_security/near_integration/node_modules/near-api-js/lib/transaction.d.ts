...
export declare const functionCall: (methodName: string, args: object | Uint8Array, gas: bigint, deposit: bigint, stringify?: typeof stringifyJsonOrBytes) => import("@near-js/transactions").Action;
